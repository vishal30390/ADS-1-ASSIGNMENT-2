...
def Bargraph1(): #Define function to creat First Bar Graph of the Urban population of the countries
...
def Bargraph2(): #Define function to creat second Bar Graph of CO2 emmision of the countries
  plt.figure(figsize=(25,10)) #To Create figure
...
def Linegraph1(): #Define function to creat first line graph of electric power consumption
...
def Linegraph2(): #Define function to creat second line graph of renewable energy consumption
  plt.figure(figsize=(11,10)) #To Create figure
...
def subplot1(): #Define a function for subplot
...
def subplot2(): #Define a function for subplot
...
Bargraph1() #calling the function
Bargraph2() #calling the function
Heatmap() #calling the function
Linegraph1() #calling the function    
Linegraph2() #calling the function
subplot1() #calling the function
subplot2() #calling the function
